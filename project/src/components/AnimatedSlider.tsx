...
export default function AnimatedSlider({ 
  ...
  return (
    ...
    >
      {/* Background track - matches scrollbar track style */}
      <div 
        className="absolute inset-0 bg-white/20 rounded-full cursor-pointer border border-white/10"
        onClick={handleClick}
        style={{ height: '8px' }}
      />
      
      {/* Filled track - matches scrollbar thumb style */}
      <div
        className="absolute left-0 top-0 bg-gradient-to-r from-red-500 to-red-600 rounded-full border border-red-400/30 shadow-lg"
        style={{ 
          height: '8px',
          width: `${percentage}%`,
