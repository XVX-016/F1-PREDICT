...
export default function SchedulePage({ onPageChange }: SchedulePageProps) {
  ...
  const getDriverNationalityFlag = (driverName: string) => {
    const nationalityMap: Record<string, string> = {
      'Max Verstappen': '­ƒç│­ƒç▒',
      'Lewis Hamilton': '­ƒç¼­ƒçº',
      'Charles Leclerc': '­ƒç▓­ƒç¿',
      'Lando Norris': '­ƒç¼­ƒçº',
      'Carlos Sainz': '­ƒç¬­ƒç©',
      'George Russell': '­ƒç¼­ƒçº',
      'Fernando Alonso': '­ƒç¬­ƒç©',
      'Oscar Piastri': '­ƒçª­ƒç║',
      'Lance Stroll': '­ƒç¿­ƒçª',
      'Pierre Gasly': '­ƒç½­ƒçÀ',
      'Esteban Ocon': '­ƒç½­ƒçÀ',
      'Alexander Albon': '­ƒç╣­ƒç¡',
      'Yuki Tsunoda': '­ƒç»­ƒçÁ',
      'Valtteri Bottas': '­ƒç½­ƒç«',
      'Nico Hulkenberg': '­ƒç®­ƒç¬',
      'Daniel Ricciardo': '­ƒçª­ƒç║',
      'Zhou Guanyu': '­ƒç¿­ƒç│',
      'Kevin Magnussen': '­ƒç®­ƒç░',
      'Logan Sargeant': '­ƒç║­ƒç©',
      'Jack Doohan': '­ƒçª­ƒç║',
      'Andrea Kimi Antonelli': '­ƒç«­ƒç╣',
      'Kimi Antonelli': '­ƒç«­ƒç╣'
    };
    return nationalityMap[driverName] || '­ƒÅü';
  };
                  ...
                  <div className="bg-gray-800/50 rounded-lg p-3">
                    ...
                    <div className="text-gray-300">
                      {race.fp1.date ? (
                        ...
                        <span className="text-gray-500">ÔÇö</span>
                      )}
                    </div>
                  </div>
