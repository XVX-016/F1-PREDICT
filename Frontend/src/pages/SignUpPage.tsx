...
export default function SignUpPage({ onPageChange }: SignUpPageProps) {
  ...
  const [signUpState, setSignUpState] = useState<'form' | 'success'>('form');
          ...
          {signUpState === 'form' ? (
            ...
            >
              ...
              <div className="bg-gradient-to-r from-yellow-500/20 to-yellow-600/20 border border-yellow-500/30 rounded-xl p-3 mb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <div className="text-yellow-300 text-xs">Access real-time physics telemetry</div>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-9 pr-3 py-2.5 bg-black/40 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/50 transition-all text-sm ${fieldErrors.username ? 'border-red-500' : 'border-white/20'
                        }`}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-9 pr-3 py-2.5 bg-black/40 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/50 transition-all text-sm ${fieldErrors.email ? 'border-red-500' : 'border-white/20'
                        }`}
                    />
                  </div>
                  {fieldErrors.email && (
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-9 pr-10 py-2.5 bg-black/40 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/50 transition-all text-sm ${fieldErrors.password ? 'border-red-500' : 'border-white/20'
                        }`}
                    />
                    <button
                      type="button"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-9 pr-10 py-2.5 bg-black/40 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/50 transition-all text-sm ${fieldErrors.confirmPassword ? 'border-red-500' : 'border-white/20'
                        }`}
                    />
                    <button
                      type="button"
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="flex items-center space-x-2 text-xs text-gray-400">
                  ...
                  <span>Analyze high-fidelity race data</span>
                </div>
              </div>
            ...
            >
              ...
              <p className="text-gray-300 mb-8">
                ...
                Please click the link to verify your account and start predicting.
              </p>
              <motion.button
                onClick={handleSwitchToSignIn}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-white/10 hover:bg-white/20 text-white px-6 py-2 rounded-xl border border-white/20 transition-all font-medium"
              >
                Go to Sign In
              </motion.button>
