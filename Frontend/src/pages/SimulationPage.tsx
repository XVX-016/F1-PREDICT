...
export default function SimulationPage() {
    ...
    return (
        <SimulationProvider>
            <div className="px-6 pt-24 pb-6 border-b border-white/5 bg-black/40 relative z-10">
                <header className="border-l-4 border-[#E10600] pl-6 py-1">
        ...
        ───────────────────────────── */}
                    ...
                    <SimulationViewport>
                        <div className="p-6 pt-40">
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 items-start">
                                <div className="h-[500px] bg-black/80 backdrop-blur-xl rounded-2xl border border-white/20 overflow-hidden flex flex-col shadow-2xl ring-1 ring-white/5 ring-inset">
            ...
            <div className="mt-48 pb-32 flex flex-col items-center justify-center">
